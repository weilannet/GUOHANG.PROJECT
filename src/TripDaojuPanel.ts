...
class TripDaojuPanel extends egret.Sprite {
    public static TRIP_DAOJU: string = "TRIP_DAOJU";
    ...
    private daoju_Sprite: egret.Sprite;
    private daojuCenter: egret.Bitmap;
    private daoju1: egret.Bitmap;
    private daoju2: egret.Bitmap;
    private daoju3: egret.Bitmap;
    private daoju4: egret.Bitmap;
    private daoju5: egret.Bitmap;
    private daoju6: egret.Bitmap;
    ...
    private onDaojuTouch(e: egret.TouchEvent) {
     ...
     private onTouchCloseTab(e: egret.TouchEvent) {
